...
<modal name="set-rpc" transition="pop-out" :width="modalWidth"
  :focus-trap="true" :height="560" @before-open="beforeOpen">
  <div class="box">
      ...
      <div class="partition">
        ...
        <div class="partition-form">
          <form>
            ...
            <div class="lbl-ipt text-center mb-2">
              <label for="3um-threshold">3 um</label>
              <input id="3um-threshold" type="text"
                v-model=threshole3um placeholder="3 um Threshold">
            </div>
            <div class="lbl-ipt text-center mb-2">
              <label for="1um-threshold">1 um</label>
              <input id="1um-threshold" type="text"
                v-model=threshole1um placeholder="1 um Threshold">
            </div>
            <div class="lbl-ipt text-center mb-2">
              <label for="05um-threshold">0.5 um</label>
              <input id="05um-threshold" type="text"
                v-model=threshole05um placeholder="0.5 um Threshold">
            </div>
  ...
  methods: {
    save() {
      ...
      this.$emit('clicked', {
        ...
        threshole3um: this.threshole3um,
        threshole1um: this.threshole1um,
        threshole05um: this.threshole05um,
    ...
    beforeOpen(event) {
      ...
      this.threshole3um = event.params.settingValue.threshole3um;
      this.threshole1um = event.params.settingValue.threshole1um;
      this.threshole05um = event.params.settingValue.threshole05um;
