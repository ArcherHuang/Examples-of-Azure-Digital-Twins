...
IOTHUB_CONNECTION_STRING="HostName=rpc-adt-hub.azure-devices.net;SharedAccessKeyName=iothubowner;SharedAccessKey=ByYNeY6Y9cR7Mu7qvQyJJvTmhAxcMhnKDGp5tQQwbdo="
IOTHUB_DEVICE_CONNECTION_STRING_DEV="HostName=rpc-adt-hub.azure-devices.net;DeviceId=percept-dt-001;SharedAccessKey=Qw4WBCdyPX/7C7oO0hxmQvSnyJrMlbhT/Ubjp0FYWq8=;SharedAccessKeyName=iothubowner"
...
async def main():
    ...
    global THERMOSTAT_1
    THERMOSTAT_1 = Thermostat(thermostat_1_component_name, 10,True, 19)
    ...
    async def send_telemetry():
        ...
        while True:
            my_dict= {}
            if(THERMOSTAT_1.run):
                curr_temp_ext = random.randrange(0, 100)
